...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['simakad.stftjakarta.ac.id','handbook.thepucukan.com','139.59.249.35','116.197.135.45'])
...
EMAIL_BACKEND = env('DJANGO_EMAIL_BACKEND', default='djangotest33.libs.django-mailgun.django_mailgun.MailgunBackend')
...
# DEFAULT_FROM_EMAIL = env(
#     'DJANGO_DEFAULT_FROM_EMAIL',
#     default='Master23 <noreply@example.com>'
# )
# # https://docs.djangoproject.com/en/dev/ref/settings/#server-email
# SERVER_EMAIL = env('DJANGO_SERVER_EMAIL', default=DEFAULT_FROM_EMAIL)
# # https://docs.djangoproject.com/en/dev/ref/settings/#email-subject-prefix
# EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[Master23]')
# 
# # ADMIN
# # ------------------------------------------------------------------------------
